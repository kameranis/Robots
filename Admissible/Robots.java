...
public class Robots {
    ...
    public static Interest Astar(Point start, Point fin, Point[] player, int size, int prev) throws Exception{
        ...
        while(!queue.isEmpty())
        {
            ...
            System.out.println(Name + ": <" + curr.pos.r +"," + curr.pos.c +"> at " + (curr.dist+prev));
        ...
        try {
            ...
            for(i=0; i<s; i++)
            {
                ...
                if(i < player2.size())
                    ...
                    pl2 = player2.get(player2.size() - 1);
                System.out.println("1 at <" + pl1.r + "," + pl1.c + "> at step " + i );
                System.out.println("2 at <" + pl2.r + "," + pl2.c + "> at step " + i );
            }
    }
    catch(Exception e)
    {
